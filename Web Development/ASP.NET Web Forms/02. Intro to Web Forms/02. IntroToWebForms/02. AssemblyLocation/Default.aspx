<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="_02.AssemblyLocation._Default" %>
...
<%--        <h1>ASP.NET</h1>
        ...
        <asp:literal runat="server" id="fromCsharp"></asp:literal>
    </div>
