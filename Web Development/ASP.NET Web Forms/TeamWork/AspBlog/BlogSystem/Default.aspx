...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:EntityDataSource ID="CategoriesEDS" runat="server" ConnectionString="name=BlogSystemEntities" DefaultContainerName="BlogSystemEntities" EnableFlattening="False" EntitySetName="Categories">
