...
namespace LizardmanCinemas.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Details()
        {
            ...
            return PartialView("_ChangeAvatarPartial", user);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ManageDetails(ManageUserDetailsViewModel model, HttpPostedFileBase file)
        {
            string userId = User.Identity.GetUserId();
            bool hasLocalLogin = await IdentityManager.Logins.HasLocalLoginAsync(userId);
            //ViewBag.HasLocalPassword = hasLocalLogin;
            ...
            if (hasLocalLogin)
            {
                if (ModelState.IsValid)
                {
                    ...
                    return RedirectToAction("Manage", new { Message = "Your details have been changed." });
                }
            }
