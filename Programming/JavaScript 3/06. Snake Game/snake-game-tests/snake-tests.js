...
module("Snake.goingFat");
test("When the snake grows, the new size should be bigger.", function () {
    var snake = new snakeGame.Snake({
        x: 150,
        y: 150
    }, 15, 0);
    ...
    ok(newsize > oldsize, "The snake is fatter.");
});

module("Snake.suicide");
test("The snake must die, when bites itself", function () {
    var iniposition = {
        x: 1,
        y: 3
    }
